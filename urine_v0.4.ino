...
int rate = 50; // 0 is stop, from slowest 15 -> 255 for full speed
...
char getPosition(){
  ...
  Serial.print(current_position); // Tell me which way you're facing and what you're doing
...
char getGoal(){
  ...
  if(override){
    if(toward_lab){
      goal = "B"; 
      Serial.print(". OVERRIDE TO BATHROOM");
    }else if(toward_bathroom){
      goal = "L"; 
      Serial.print(". OVERRIDE TO LAB");
    }
  }
  Serial.print(". Goal: ");
  Serial.print(goal); // Tell me where you wanna be
